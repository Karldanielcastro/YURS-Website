...
@media screen and (min-width: 0px) and (max-width: 1000px) {
  ...
  .menu > li {
    ...
    .img-1{
        background-image: url(image/in4-show1.jpg);
    }
    .img-2{
        background-image: url(image/in4-show2.jpg);
    }
    .img-3{
        background-image: url(image/in4-show3.jpg);
    }
...
<body>
  ...
  <section class="top-nav">
    ...
    <div class="box">
        <h1 id="letter">iFly Dubai</h1>
    </div>

    <section class="location">
    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3609.6850070131713!2d55.40625251500983!3d25.21384308388835!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3e5f60b40665ca49%3A0x901ae72a1e8dbb17!2siFly%20Dubai!5e0!3m2!1sen!2sae!4v1654188733351!5m2!1sen!2sae" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
    ...
    <section class="about">
        ...
        <div class="about-pages">
            <div>
                <img class ="image-parallax" src="image/in4-des1.jpg">
                <p>Experience the sensation of flying in our state-of-the-art vertical wind tunnels. Safe for all ages, experience levels and abilities, indoor sky diving at iFLY is a family-friendly activity perfect for kid’s birthday parties, corporate events, team building, and more.</p>
            </div>
            <div>
                <img class ="image-parallax" src="image/in4-des2.jpg">
                <p>If you’re looking for an attraction virtually guaranteed to blow you away, head to iFly Dubai. Located at City Centre Mirdif, it’s the first 10m double vertical glass wind tunnel attached to a shopping mall. It also one of the first indoor skydiving centres to ever open in the region.</p>
            </div>
            <div>
                <img class ="image-parallax" src="image/in4-des3.jpg">
                <p>Once fully prepared with a wind-suit and eye protection, you’ll enter the tunnel and fall forwards into the wind gust generated from beneath you. Under the tutelage of an expert instructor who accompanies you inside the tunnel, you need not feel intimidated by pre-fall jitters.</p>
            </div>
        </div>
    </section>
    ...
    <section class="review">
        ...
        <form method="post" action="./php/in4.php">
            <div class="em">
