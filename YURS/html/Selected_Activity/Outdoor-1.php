...
@media screen and (min-width: 0px) and (max-width: 1000px) {
  ...
  .menu > li {
    ...
    .img-1{
        background-image: url(image/al-quadra.jpg);
    }
    .img-2{
        background-image: url(image/al-quadra-2.jpg);
    }
    .img-3{
        background-image: url(image/al-quadra-3.jpg);
    }
...
<body>
  ...
  <section class="top-nav">
    ...
    <div class="box">
        <h1 id="letter">Al Quadra Lakes</h1>
    </div>

    <section class="location">
    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d115864.65886764797!2d55.24439785000973!3d24.837517831156777!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3e5f83ed9a5baf39%3A0x7dd97b4910bc2a00!2sAl%20Qudra%20Lakes!5e0!3m2!1sen!2sae!4v1654007510710!5m2!1sen!2sae" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
    ...
    <section class="about">
        ...
        <div class="about-pages">
            <div>
                <img class ="image-parallax" src="image/al-quadra-2.jpg">
                <p>Al Qudra Lake has been Dubai’s favorite recreational location. This desert oasis offers you a comfortable escape from the city and a range of enjoyable activities that will allow you to rest and relax. If you’re an outdoor enthusiast, you shouldn’t miss the Al Qudra Lake destination.</p>
            </div>
            <div>
                <img class ="image-parallax" src="image/al-quadra-info2.jpg">
                <p>Al Qudra cycling path is the most popular destination among UAE's cycling community. The 86-kilometre track, consisting primarily of a 50km loop, is a free pedal power paradise located near Studio City and Arabian Ranches.</p>
            </div>
            <div>
                <img class ="image-parallax" src="image/al-quadra-info3.jpg">
                <p>Al Qudra Lake continues to be popular with campers and is one of the best BBQ spots in Dubai. We would not be disappointed if you were to load up your BBQ equipment for the following weekend and head to this artificial desert oasis.</p>
            </div>
        </div>
    </section>
    ...
    <section class="review">
        ...
        <form method="post" action="./php/out1.php">
            <div class="em">
