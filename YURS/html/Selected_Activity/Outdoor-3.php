...
@media screen and (min-width: 0px) and (max-width: 1000px) {
  ...
  .menu > li {
    ...
    .img-1{
        background-image: url(image/out3-show1.jpg);
    }
    .img-2{
        background-image: url(image/out3-show2.jpg);
    }
    .img-3{
        background-image: url(image/out3-show3.jpg);
    }
...
<body>
  ...
  <section class="top-nav">
    ...
    <div class="box">
        <h1 id="letter">Visit Hatta Wadi Hub</h1>
    </div>

    <section class="location">
    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d28973.398972920502!2d56.09055107910156!3d24.806584300000004!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3ef51ed5c87c838f%3A0xbb6fdcc40a937f05!2sHatta!5e0!3m2!1sen!2sae!4v1654118585588!5m2!1sen!2sae" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
    ...
    <section class="about">
        ...
        <div class="about-pages">
            <div>
                <img class ="image-parallax" src="image/out3-des1.jpg">
                <p>Leave the city behind and head for the picturesque mountains of Hatta, where a cool climate, rugged horizons and untamed natural environment make for the perfect ecotourism adventure destination in Dubai’s most spectacular National Park. </p>
            </div>
            <div>
                <img class ="image-parallax" src="image/out3-des2.jpg">
                <p>Rent a mountain bike and tackle 52km of trails, colour-coded according to difficulty, or hike Hatta’s rolling peaks at your own pace. Visitors can also book alternative thrills such as archery or axe-throwing, or try zorbing nearby where you’ll roll downhill inside a giant transparent ball.</p>
            </div>
            <div>
                <img class ="image-parallax" src="image/out3-des3.jpg">
                <p>The rugged exclave is the perfect escape for thrill-seekers thanks to Hatta Wadi Hub, an activity centre with something to suit every adventurer, both big or small.</p>
            </div>
        </div>
    </section>
    ...
    <section class="review">
        ...
        <form method="post" action="./php/out3.php">
            <div class="em">
