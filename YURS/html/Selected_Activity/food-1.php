...
@media screen and (min-width: 0px) and (max-width: 1000px) {
  ...
  .menu > li {
    ...
    .img-1{
        background-image: url(image/food1-show1.jpg);
    }
    .img-2{
        background-image: url(image/food1-show2.jpg);
    }
    .img-3{
        background-image: url(image/food1-show3.jpg);
    }
...
<body>
  ...
  <section class="top-nav">
    ...
    <div class="box">
        <h1 id="letter">Ossiano, Atlantis The Palm</h1>
    </div>

    <section class="location">
    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3612.131462146404!2d55.115384715008204!3d25.131245983926867!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3e5f153e489d9f59%3A0xe952e0dc5c5ab064!2sOssiano!5e0!3m2!1sen!2sae!4v1654127808635!5m2!1sen!2sae" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
    ...
    <section class="about">
        ...
        <div class="about-pages">
            <div>
                <img class ="image-parallax" src="image/food1-des1.jpg">
                <p>Ossiano Dubai, a progressive fine dining experience inspired by the ocean and seas. Imagine dining in one of Dubai’s most immersive restaurants, as stingrays, sharks and fish glide right past your table.</p>
            </div>
            <div>
                <img class ="image-parallax" src="image/food1-des2.jpg">
                <p>Take part in an exceptional four hands event in Ossiano, with Chef Grégoire Berger hosting Michelin two-star Chef Paco Morales of Spain's dazzling Al-Andalus Arab restaurant, Noor. </p>
            </div>
            <div>
                <img class ="image-parallax" src="image/food1-des3.jpg">
                <p>Ossiano, a journey inspired by the oceans and seas aims to give you emotions throughout your dining experience. The emphasis on story telling is to transport you into our underwater universe through food. </p>
            </div>
        </div>
    </section>
    ...
    <section class="review">
        ...
        <form method="post" action="./php/food1.php">
            <div class="em">
