...
@media screen and (min-width: 0px) and (max-width: 1000px) {
  ...
  .menu > li {
    ...
    .img-1{
        background-image: url(image/food4-show1.jpg);
    }
    .img-2{
        background-image: url(image/food4-show2.jpg);
    }
    .img-3{
        background-image: url(image/food4-show3.jpg);
    }
...
<body>
  ...
  <section class="top-nav">
    ...
    <div class="box">
        <h1 id="letter">CZN BURAK</h1>
    </div>

    <section class="location">
    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3610.222867131514!2d55.276144515009555!3d25.19570558389685!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3e5f6955cdc0a649%3A0xf08ece466df23124!2sCZN%20BURAK!5e0!3m2!1sen!2sae!4v1654128866436!5m2!1sen!2sae" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
    ...
    <section class="about">
        ...
        <div class="about-pages">
            <div>
                <img class ="image-parallax" src="image/food4-des1.jpg">
                <p>Celebrities including the Crown Prince of Dubai, His Highness Sheikh Hamdan bin Mohammed bin Rashid Al Maktoum, Egyptian superstar Mohammed Ramadan, renowned MMA fighter Khabib Nurmagomedov, and Bollywood star Nora Fatehi have all graced the Downtown Dubai venue since it opened on Christmas Day, 2020.</p>
            </div>
            <div>
                <img class ="image-parallax" src="image/food4-des2.jpg">
                <p>Serving a blend of Turkish and Middle Eastern cuisine, CZNBurak has a seating capacity of 600, which will rise to 1,200 post-Covid restrictions, and also features the biggest oven in the GCC.</p>
            </div>
            <div>
                <img class ="image-parallax" src="image/food4-des3.jpg">
                <p>But the biggest draw to the venue is the chef himself, with Özdemir commanding 20 million followers on Instagram and regularly posing with customers in his outlet.</p>
            </div>
        </div>
    </section>
    ...
    <section class="review">
        ...
        <form method="post" action="./php/food4.php">
            <div class="em">
