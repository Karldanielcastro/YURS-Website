...
@media screen and (min-width: 0px) and (max-width: 1000px) {
  ...
  .menu > li {
    ...
    .img-1{
        background-image: url(image/water1-show1.jpg);
    }
    .img-2{
        background-image: url(image/water1-show2.jpg);
    }
    .img-3{
        background-image: url(image/water1-show3.jpg);
    }
...
<body>
  ...
  <section class="top-nav">
    ...
    <div class="box">
        <h1 id="letter">AquaFun Waterpark</h1>
    </div>

    <section class="location">
    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3613.693825548841!2d55.12855701500713!3d25.078364483951646!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3e5f5b13203b4619%3A0x220e567f088a39d3!2sAquaFun%20Water%20Park!5e0!3m2!1sen!2sae!4v1654124980721!5m2!1sen!2sae" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
    ...
    <section class="about">
        ...
        <div class="about-pages">
            <div>
                <img class ="image-parallax" src="image/water1-des1.jpg">
                <p>Experience and enjoy your time in Dubai with epic fun under the sun.  AQUA FUN is the ultimate destination for tourists and residents from 120+ countries, featured as the Top #5 things to do in Dubai.</p>
            </div>
            <div>
                <img class ="image-parallax" src="image/water1-des2.jpg">
                <p>Measuring at 130M X 33M with over 72+ obstacles and 25 metres out at Sea. You will be in for an exciting adventure. Go ahead book today, you do not want to miss this!</p>
            </div>
            <div>
                <img class ="image-parallax" src="image/water1-des3.jpg">
                <p>We’re in the heart of one of the busiest beach fronts in the United Arab Emirates – Jumeriah Beach Residence (JBR). There are over 45+ restaurants, 1 Cinema, directly opposite the Dubai Eye within walking distance.</p>
            </div>
        </div>
    </section>
    ...
    <section class="review">
        ...
        <form method="post" action="./php/water1.php">
            <div class="em">
