...
@media screen and (min-width: 0px) and (max-width: 1000px) {
  ...
  .menu > li {
    ...
    .img-1{
        background-image: url(image/out5-show1.jpg);
    }
    .img-2{
        background-image: url(image/out5-show2.jpg);
    }
    .img-3{
        background-image: url(image/out5-show3.jpg);
    }
...
<body>
  ...
  <section class="top-nav">
    ...
    <div class="box">
        <h1 id="letter">Explore Wadi Showka</h1>
    </div>

    <section class="location">
    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d57822.01879564648!2d56.00403810431255!3d25.072185692209327!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3ef5a860924ce5f1%3A0xde4bf3141b96ff8b!2sWadi%20Shawka!5e0!3m2!1sen!2sae!4v1654123627445!5m2!1sen!2sae" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
    ...
    <section class="about">
        ...
        <div class="about-pages">
            <div>
                <img class ="image-parallax" src="image/out5-des1.jpg">
                <p>A valley in the mountains of Ras Al Khaima in the UAE, perfect for a picnic, hike or just to escape from the city.</p>
            </div>
            <div>
                <img class ="image-parallax" src="image/out5-des2.jpg">
                <p>Wadi Showka in RAK is known to be one of the most popular places for hikers in UAE. It is known for its beautiful landscape as well as natural pools that are frequented by residents as well as tourists alike.</p>
            </div>
            <div>
                <img class ="image-parallax" src="image/out5-des3.jpg">
                <p>Located on the Eastern exteriors of the Ras Al Khaimah Emirate, Shawka dam is only an hour-long drive from Dubai. Nestled between Moon-like Hajar Mountains, Shawka (Showka) area serves as an ideal start for a relatively easy trekking adventure.</p>
            </div>
        </div>
    </section>
    ...
    <section class="review">
        ...
        <form method="post" action="./php/out5.php">
            <div class="em">
