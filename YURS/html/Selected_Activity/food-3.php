...
@media screen and (min-width: 0px) and (max-width: 1000px) {
  ...
  .menu > li {
    ...
    .img-1{
        background-image: url(image/food3-show1.jpg);
    }
    .img-2{
        background-image: url(image/food3-show2.jpg);
    }
    .img-3{
        background-image: url(image/food3-show3.jpg);
    }
...
<body>
  ...
  <section class="top-nav">
    ...
    <div class="box">
        <h1 id="letter">Splendido Bar & Kitchen</h1>
    </div>

    <section class="location">
    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3613.5746919832736!2d55.135441815007304!3d25.082400483949783!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3e5f6b54aa99a939%3A0x32a6071414dd2140!2sSplendido%20Bar%20%26%20Kitchen!5e0!3m2!1sen!2sae!4v1654128423841!5m2!1sen!2sae" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
    ...
    <section class="about">
        ...
        <div class="about-pages">
            <div>
                <img class ="image-parallax" src="image/food3-des1.jpg">
                <p>Splendido restaurant at The Walk, JBR is much like Italy itself; effortlessly sophisticated, romantic and inviting. The menu showcases the best of Italian cuisine including homemade pastas, fresh seafood and rich desserts. Curated regional are dishes complemented by bold aperitifs, Italian wine and cocktails. </p>
            </div>
            <div>
                <img class ="image-parallax" src="image/food3-des2.jpg">
                <p>Curated regional are dishes complemented by bold aperitifs, Italian wine and cocktails. Dine al fresco on the Tuscan-style terrace, amid the summer gardens on the piazza or in the chic, Mediterranean-inspired dining room.</p>
            </div>
            <div>
                <img class ="image-parallax" src="image/food3-des3.jpg">
                <p>Splendido once offered an atmospheric view of the beach and sea. Now, another part of the Ritz is being constructed in front of it and this view is obscured. However, the outdoor area is still perfectly pleasant, encircled by trees and greenery. Inside you’ll find a traditional Italian restaurant, complete with white tablecloths and a slightly formal atmosphere.</p>
            </div>
        </div>
    </section>
    ...
    <section class="review">
        ...
        <form method="post" action="./php/food3.php">
            <div class="em">
