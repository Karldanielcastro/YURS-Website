...
@media screen and (min-width: 0px) and (max-width: 1000px) {
  ...
  .menu > li {
    ...
    .img-1{
        background-image: url(image/water6-show1.jpg);
    }
    .img-2{
        background-image: url(image/water6-show2.jpg);
    }
    .img-3{
        background-image: url(image/water6-show3.jpg);
    }
...
<body>
  ...
  <section class="top-nav">
    ...
    <div class="box">
        <h1 id="letter">Dreamland Aqua Park</h1>
    </div>

    <section class="location">
    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3598.523108637306!2d55.657246715017365!3d25.587528183716103!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3ef5fcd7b547266b%3A0x8afe5187d3b0c3b1!2sDreamland%20Aqua%20Park!5e0!3m2!1sen!2sae!4v1654125693521!5m2!1sen!2sae" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
        <img id = "state"src="image/umal.png">
    </section>
    ...
    <section class="about">
        ...
        <div class="about-pages">
            <div>
                <img class ="image-parallax" src="image/water6-des1.jpg">
                <p>Umm Al Quwain Dreamland is the largest family water park in the region with over 250,000 square meters expanse of lush, green, landscaped gardens. Located on the scenic coastline of Umm Al Quwain, it has become more accessible to tourists coming from other Emirates.</p>
            </div>
            <div>
                <img class ="image-parallax" src="image/water6-des2.jpg">
                <p>Dreamland Aqua Park started out with 25 water attractions enjoyed by all age groups. In September 2004, five more attractions were added to the already thrilling and heart-stopping wet rides.</p>
            </div>
            <div>
                <img class ="image-parallax" src="image/water6-des3.jpg">
                <p>Dreamland also has overnight waterside camping facilities in either tents or cabanas in addition to a Mini Zoo and Sporting Facilities. Food is not a restraint at Dreamland with 5 different outlets to suites all your tastes. The Park is operated all year round with a daily capacity of 12,000 visitors.</p>
            </div>
        </div>
    </section>
    ...
    <section class="review">
        ...
        <form method="post" action="./php/water6.php">
            <div class="em">
