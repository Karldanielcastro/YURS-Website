...
@media screen and (min-width: 0px) and (max-width: 1000px) {
  ...
  .menu > li {
    ...
    .img-1{
        background-image: url(image/in2-show1.jpg);
    }
    .img-2{
        background-image: url(image/in2-show2.jpg);
    }
    .img-3{
        background-image: url(image/in2-show3.jpg);
    }
...
<body>
  ...
  <section class="top-nav">
    ...
    <div class="box">
        <h1 id="letter">IMG Worlds of Adventure</h1>
    </div>

    <section class="location">
    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3613.5822372473476!2d55.315882715007234!3d25.08214488394978!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3e5f657f294183b3%3A0x10bf0d691ce2f9c2!2sIMG%20Worlds%20of%20Adventure!5e0!3m2!1sen!2sae!4v1654186860981!5m2!1sen!2sae" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
    ...
    <section class="about">
        ...
        <div class="about-pages">
            <div>
                <img class ="image-parallax" src="image/in2-des1.jpg">
                <p>IMG Worlds of Adventure is one of Dubai's best theme parks, bringing Marvel and Cartoon Network characters to life with state-of-the-art rides. Covering an area of more than 28 football fields, you’ll want to ensure you’re wearing comfortable shoes on your visit here.</p>
            </div>
            <div>
                <img class ="image-parallax" src="image/in2-des2.jpg">
                <p>From live stage shows and meet-and-greets featuring action icons like Iron Man or The Powerpuff Girls to unique experiences like the Haunted Hotel or Thor Thunder Spin, this Dubai indoor theme park offers nonstop excitement for adventure seekers of all ages.</p>
            </div>
            <div>
                <img class ="image-parallax" src="image/in2-des3.jpg">
                <p>Among Dubai’s largest parks, IMG Worlds of Adventure is split into zones dedicated to best-loved cartoon and superhero themes – the interiors come alive with the energy of The Avengers, colourful tropes of LazyTown and life-sized dinosaurs of The Lost Valley.</p>
            </div>
        </div>
    </section>
    ...
    <section class="review">
        ...
        <form method="post" action="./php/in2.php">
            <div class="em">
