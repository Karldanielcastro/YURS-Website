...
@media screen and (min-width: 0px) and (max-width: 1000px) {
  ...
  .menu > li {
    ...
    .img-1{
        background-image: url(image/food2-show1.jpg);
    }
    .img-2{
        background-image: url(image/food2-show2.jpg);
    }
    .img-3{
        background-image: url(image/food2-show3.jpg);
    }
...
<body>
  ...
  <section class="top-nav">
    ...
    <div class="box">
        <h1 id="letter">The MAINE Oyster Bar & Grill, JBR</h1>
    </div>

    <section class="location">
    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3613.8621936217664!2d55.125754315007065!3d25.07265948395419!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3e5f1357958d9b11%3A0x6e30dc6e53346a42!2sThe%20MAINE%20Oyster%20Bar%20%26%20Grill%2C%20JBR!5e0!3m2!1sen!2sae!4v1654128100103!5m2!1sen!2sae" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
    ...
    <section class="about">
        ...
        <div class="about-pages">
            <div>
                <img class ="image-parallax" src="image/food2-des1.jpg">
                <p>This popular restaurant, which picked up a Highly Commended gong in the North American and Caribbean category at the Time Out Dubai Restaurant Awards 2020, is always heaving and has been super-popular since it opened back in 2015. </p>
            </div>
            <div>
                <img class ="image-parallax" src="image/food2-des2.jpg">
                <p>The vibe here is always buzzing, especially on a Wednesday ladies’ night where women get free drinks at the bar. It’s a low-key, cool spot that you’ll find yourself returning to time and again, and you won’t regret it.</p>
            </div>
            <div>
                <img class ="image-parallax" src="image/food2-des3.jpg">
                <p>If you’re a seafood fan then you’ll be happy here. From the starters the fish tacos are standout – sizeable tortillas bursting with fresh fish and slaw. And we’ve long waxed lyrical about the spicy shrimp linguine – which does exactly what it says on the tin, being fiery and delicious in a rich tomato sauce.</p>
            </div>
        </div>
    </section>
    ...
    <section class="review">
        ...
        <form method="post" action="./php/food2.php">
            <div class="em">
