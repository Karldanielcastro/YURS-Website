...
@media screen and (min-width: 0px) and (max-width: 1000px) {
  ...
  .menu > li {
    ...
    .img-1{
        background-image: url(image/in5-show1.jpg);
    }
    .img-2{
        background-image: url(image/in5-show2.jpg);
    }
    .img-3{
        background-image: url(image/in5-show3.jpg);
    }
...
<body>
  ...
  <section class="top-nav">
    ...
    <div class="box">
        <h1 id="letter">Ferrari World</h1>
    </div>

    <section class="location">
    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d929548.5116573705!2d53.48640113125002!3d24.48376339999999!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3e5e457e2d394a05%3A0x6076df4876c470a9!2sFerrari%20World%20Abu%20Dhabi!5e0!3m2!1sen!2sae!4v1654189782678!5m2!1sen!2sae" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
    ...
    <section class="about">
        ...
        <div class="about-pages">
            <div>
                <img class ="image-parallax" src="image/in5-des1.jpg">
                <p>Love speed? Then gear up for the ride of your life only here at Ferrari World Abu Dhabi. Home to the world's fastest rollercoaster, the highest loop ride, the tallest space-frame structure ever built on the planet and over 40 record-breaking attractions, this is the ultimate destination for non-stop, hyper-adrenaline, heart-racing fun!</p>
            </div>
            <div>
                <img class ="image-parallax" src="image/in5-des2.jpg">
                <p>The fastest rollercoaster in the entire world awaits you. Buckle up and prepare to be blasted 240km/h in 4.9 seconds on the world’s fastest rollercoaster.</p>
            </div>
            <div>
                <img class ="image-parallax" src="image/in5-des3.jpg">
                <p>Only at the largest indoor theme park on the planet and the first Ferrari-branded theme park in the world, located in the heart of the fascinating Yas Island. In between rides, get to see magical shows, savor the flavors of Italy and get exclusive access into the fast, prestigious world of luxury Italian supercars and their racing legends.</p>
            </div>
        </div>
    </section>
    ...
    <section class="review">
        ...
        <form method="post" action="./php/in5.php">
            <div class="em">
