...
@media screen and (min-width: 0px) and (max-width: 1000px) {
  ...
  .menu > li {
    ...
    .img-1{
        background-image: url(image/water2-show1.jpg);
    }
    .img-2{
        background-image: url(image/water2-show2.jpg);
    }
    .img-3{
        background-image: url(image/water2-show3.jpg);
    }
...
<body>
  ...
  <section class="top-nav">
    ...
    <div class="box">
        <h1 id="letter">Wild Wadi Waterpark</h1>
    </div>

    <section class="location">
    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3611.8900152970377!2d55.18665531500837!3d25.139408983923104!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3e5f6a511ed4b287%3A0xe1a35f0efa60846c!2sWild%20Wadi%20Waterpark!5e0!3m2!1sen!2sae!4v1654125858511!5m2!1sen!2sae" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
    ...
    <section class="about">
        ...
        <div class="about-pages">
            <div>
                <img class ="image-parallax" src="image/water2-des1.jpg">
                <p>Located in Dubai and situated in front of the stunning Burj Al Arab, Wild Wadi offers 30 rides and attractions for all the family. Wild Wadi is themed around the tale of Juha, a known character from the Arabian folklore.</p>
            </div>
            <div>
                <img class ="image-parallax" src="image/water2-des2.jpg">
                <p>Visit the city's favorite water park, Wild Wadi Dubai, for a day of pure fun.Whether you are in the mood to lounge by the pool or embark on a roller coaster ride, Wild Wadi has got you covered!</p>
            </div>
            <div>
                <img class ="image-parallax" src="image/water2-des3.jpg">
                <p>Try out over 30 exciting rides, from the stormy Tantrum Alley to the dizzying plunge down the 105-foot Jumeirah Sceirah. Note: Due to COVID restrictions and government rules, the operating hours can change anytime. Please confirm the timings of each attraction before your visit.</p>
            </div>
        </div>
    </section>
    ...
    <section class="review">
        ...
        <form method="post" action="./php/water2.php">
            <div class="em">
