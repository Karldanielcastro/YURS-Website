...
@media screen and (min-width: 0px) and (max-width: 1000px) {
  ...
  .menu > li {
    ...
    .img-1{
        background-image: url(image/out2-show1.jpg);
    }
    .img-2{
        background-image: url(image/out2-show2.jpg);
    }
    .img-3{
        background-image: url(image/out2-show3.jpg);
    }
...
<body>
  ...
  <section class="top-nav">
    ...
    <div class="box">
        <h1 id="letter">Kayak Through the Abu Dhabi Mangroves</h1>
    </div>

    <section class="location">
    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3632.116604911413!2d54.4369051649947!3d24.446739434250716!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3e5e43266a16b545%3A0x314071f34f7eb559!2sMangrove%20Adventures%20-%20Eastern%20Mangroves%20Promenade!5e0!3m2!1sen!2sae!4v1654118003312!5m2!1sen!2sae" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
        <img id = "state"src="image/auh.png">
    </section>
    ...
    <section class="about">
        ...
        <div class="about-pages">
            <div>
                <img class ="image-parallax" src="image/out2-des1.jpg">
                <p>Bringing water and adrenaline-filled adventure together, Wadi Adventure is home to the region’s first man-made white-water rafting, kayaking and surf facility, set in the foothills of the majestic Jebel Hafit mountain in Al Ain, Abu Dhabi’s lush garden city and heritage heartland about 90-minutes drive from the capital.</p>
            </div>
            <div>
                <img class ="image-parallax" src="image/out2-des2.jpg">
                <p>Looking for a fun and healthy day out that’s perfect for the whole family? Sea Hawk Water Sports & Adventures offers three-times daily, two-hour kayaking trips through Abu Dhabi’s vast mangrove forests that characterise Abu Dhabi’s pristine coastline. Prices start from AED 160 for adults, and AED 130 for kids aged three to 12.</p>
            </div>
            <div>
                <img class ="image-parallax" src="image/out2-des3.jpg">
                <p>The park’s 1.7-kilometre kayaking channel network is the world’s longest, with lessons provided by certified trainers covering all competency levels. Guests can bring their own equipment, rent, or buy gear from the resort’s shop.</p>
            </div>
        </div>
    </section>
    ...
    <section class="review">
        ...
        <form method="post" action="./php/out2.php">
            <div class="em">
