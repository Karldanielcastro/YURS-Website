...
@media screen and (min-width: 0px) and (max-width: 1000px) {
  ...
  .menu > li {
    ...
    .img-1{
        background-image: url(image/in1-show1.jpg);
    }
    .img-2{
        background-image: url(image/in1-show2.jpg);
    }
    .img-3{
        background-image: url(image/in1-show3.jpg);
    }
...
<body>
  ...
  <section class="top-nav">
    ...
    <div class="box">
        <h1 id="letter">Ski Dubai</h1>
    </div>

    <section class="location">
    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3612.5466276917705!2d55.19612251500804!3d25.117203983933432!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3e5f6bbeefffffff%3A0x12bb675f5f36f86e!2sSki%20Dubai!5e0!3m2!1sen!2sae!4v1654185867990!5m2!1sen!2sae" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
    ...
    <section class="about">
        ...
        <div class="about-pages">
            <div>
                <img class ="image-parallax" src="image/in1-des1.jpg">
                <p>A fun day out for the entire family awaits at the Middle East’s very first indoor ski resort. With diverse activities that are sure to bring a smile to everyone’s face, Ski Dubai offers a variety of exciting activities, giving you a chance to ski, snowboard toboggan and experience a penguin encounter all under one roof.</p>
            </div>
            <div>
                <img class ="image-parallax" src="image/in1-des2.jpg">
                <p>Visit the famous Ski Dubai Slope for thrills, chills and some serious winter fun. With various packages available, you can hit the slopes and discover why this snow-filler attraction is one of Dubai's must-visit destinations.</p>
            </div>
            <div>
                <img class ="image-parallax" src="image/in1-des3.jpg">
                <p>Enjoy an up-close and personal encounter with Ski Dubai’s resident colony of Gentoo and King Penguins. Prepare to be amased by the phenomenal March of the Penguins show or enjoy the wide range of Ski Dubai penguin encounters and experiences on offer.</p>
            </div>
        </div>
    </section>
    ...
    <section class="review">
        ...
        <form method="post" action="./php/in1.php">
            <div class="em">
