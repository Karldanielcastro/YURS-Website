...
@media screen and (min-width: 0px) and (max-width: 1000px) {
  ...
  .menu > li {
    ...
    .img-1{
        background-image: url(image/water4-show1.jpg);
    }
    .img-2{
        background-image: url(image/water4-show2.jpg);
    }
    .img-3{
        background-image: url(image/water4-show3.jpg);
    }
...
<body>
  ...
  <section class="top-nav">
    ...
    <div class="box">
        <h1 id="letter">LEGOLAND Waterpark</h1>
    </div>

    <section class="location">
    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3618.30495986427!2d55.005666815004105!3d24.921678984025007!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3e5f0fbf4a88dbcd%3A0x66aa4cc808605182!2sLEGOLAND%20Water%20Park!5e0!3m2!1sen!2sae!4v1654126489108!5m2!1sen!2sae" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
        <img id = "state"src="image/PngItem_1552849 2.png">
    </section>
    ...
    <section class="about">
        ...
        <div class="about-pages">
            <div>
                <img class ="image-parallax" src="image/water4-des1.jpg">
                <p>LEGOLAND® Water Park is the only UAE water park designed specifically for kids aged 2-12 and their families. At this unique Water Park, take on the Joker Soaker, build your very own LEGO® raft, go on a splash safari or slip and slide your way down one of our many attractions!</p>
            </div>
            <div>
                <img class ="image-parallax" src="image/water4-des2.jpg">
                <p>LEGOLAND® Water Park is the new fully-themed water park designed for families with children. Children under the age of 12 are not allowed to enter LEGOLAND® Water Park unless accompanied by an adult. To ensure the safety and enjoyment of the little ones, adults may only enter LEGOLAND® Water Park if accompanying one or more children under 12 years of age.</p>
            </div>
            <div>
                <img class ="image-parallax" src="image/water4-des3.jpg">
                <p>Fun is guaranteed at LEGOLAND® Water Park, where you can dive into millions of LEGO® bricks, in a sea of interactive water games, play on the colorful slides and relax in the extraordinary fully themed areas! And even the little ones can explore, give life to their constructions and have fun with the first water games suitable for children.</p>
            </div>
        </div>
    </section>
    ...
    <section class="review">
        ...
        <form method="post" action="./php/water4.php">
            <div class="em">
