...
@media screen and (min-width: 0px) and (max-width: 1000px) {
  ...
  .menu > li {
    ...
    .img-1{
        background-image: url(image/in3-show1.jpg);
    }
    .img-2{
        background-image: url(image/in3-show2.jpg);
    }
    .img-3{
        background-image: url(image/in3-show3.jpg);
    }
...
<body>
  ...
  <section class="top-nav">
    ...
    <div class="box">
        <h1 id="letter">Tee & Putt Mini Golf</h1>
    </div>

    <section class="location">
    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3609.1954662773223!2d55.31716031501016!3d25.23034058388074!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3e5f5d35fbad3c11%3A0x7dd6412601724f3!2sTee%20%26%20Putt%20Mini%20Golf!5e0!3m2!1sen!2sae!4v1654187479586!5m2!1sen!2sae" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
    ...
    <section class="about">
        ...
        <div class="about-pages">
            <div>
                <img class ="image-parallax" src="image/in3-des1.jpg">
                <p>Tee & Putt is an 18-hole Glow-in-the-dark indoor mini golf comes with a fun twist – a world full of fun and imagination, with neon colors & out-of-this-world space theme.</p>
            </div>
            <div>
                <img class ="image-parallax" src="image/in3-des2.jpg">
                <p>This 10,000 square feet facility is to provide a world-class family entertainment and amusement avenue for residents and tourists.</p>
            </div>
            <div>
                <img class ="image-parallax" src="image/in3-des3.jpg">
                <p>Every course and hole design is unique, and miniature golfers of all abilities find it challenging, yet fun to play! Mini Golf is entertaining for adults and children of all ages."</p>
            </div>
        </div>
    </section>
    ...
    <section class="review">
        ...
        <form method="post" action="./php/in3.php">
            <div class="em">
