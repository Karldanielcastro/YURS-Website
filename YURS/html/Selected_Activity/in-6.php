...
@media screen and (min-width: 0px) and (max-width: 1000px) {
  ...
  .menu > li {
    ...
    .img-1{
        background-image: url(image/in6-show1.jpg);
    }
    .img-2{
        background-image: url(image/in6-show2.jpg);
    }
    .img-3{
        background-image: url(image/in6-show3.jpg);
    }
...
<body>
  ...
  <section class="top-nav">
    ...
    <div class="box">
        <h1 id="letter">Bounce Abu Dhabi</h1>
    </div>

    <section class="location">
    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3631.252086122471!2d54.317710314995246!3d24.47672098423629!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3e5e65b7494b4b39%3A0xa92da19a13999abf!2sBOUNCE%20Abu%20Dhabi!5e0!3m2!1sen!2sae!4v1654189894043!5m2!1sen!2sae" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
    ...
    <section class="about">
        ...
        <div class="about-pages">
            <div>
                <img class ="image-parallax" src="image/in6-des1.jpg">
                <p>Freestyle is all about expressing yourself through movement. At BOUNCE, we’ll show you how to level up your Freestyle moves in a safe and controlled environment. Our huge venues are the perfect playground to develop and practice your skills.</p>
            </div>
            <div>
                <img class ="image-parallax" src="image/in6-des2.jpg">
                <p>BOUNCE Abu Dhabi has become one of the best indoor venues in the emirate offering exciting and fun activities for kids and adults alike. After the huge success of BOUNCE Dubai, this indoor trampoline park is a welcome addition to the capital’s list of unique family-friendly attractions.</p>
            </div>
            <div>
                <img class ="image-parallax" src="image/in6-des3.jpg">
                <p>BOUNCE is a freestyle playground with its origins in Melbourne Australia. Currently, they operate from 32 locations across four continents. BOUNCE also has a notable presence in the UAE with branches operating in Dubai, Abu Dhabi and Al Ain.</p>
            </div>
        </div>
    </section>
    ...
    <section class="review">
        ...
        <form method="post" action="./php/in6.php">
            <div class="em">
