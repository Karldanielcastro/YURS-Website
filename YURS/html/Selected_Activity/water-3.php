...
@media screen and (min-width: 0px) and (max-width: 1000px) {
  ...
  .menu > li {
    ...
    .img-1{
        background-image: url(image/water3-show1.jpg);
    }
    .img-2{
        background-image: url(image/water3-show2.jpg);
    }
    .img-3{
        background-image: url(image/water3-show3.jpg);
    }
...
<body>
  ...
  <section class="top-nav">
    ...
    <div class="box">
        <h1 id="letter">Aquaventure Waterpark</h1>
    </div>

    <section class="location">
    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d7224.079314082536!2d55.116946075144384!3d25.134350085701442!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3e5f43496ad9c645%3A0xb78f1e79bffcf25d!2sAquaventure%20Waterpark!5e0!3m2!1sen!2sae!4v1654126311249!5m2!1sen!2sae" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
    ...
    <section class="about">
        ...
        <div class="about-pages">
            <div>
                <img class ="image-parallax" src="image/water3-des1.jpg">
                <p>Start exploring the world’s largest waterpark and get your pulse racing with over 105 record-breaking slides, attractions and experiences, make your way through the Raging Rapids, and relax on 1km of private beach.</p>
            </div>
            <div>
                <img class ="image-parallax" src="image/water3-des2.jpg">
                <p>Explore Aquaventure's Shark Lagoon and the hundreds of marine animals that call it their home. Go on a Shark Safari and surround yourself by countless sharks and rays during this once-in-a-lifetime experience or take a journey on a fun-filled adventure and learn all about marine life with the NEW Mini Marine Biologist Programme.</p>
            </div>
            <div>
                <img class ="image-parallax" src="image/water3-des3.jpg">
                <p>Aquaventure Waterpark is located in The Avenues at Atlantis, The Palm. If you are arriving by car, please park your vehicle at Aquaventure Waterpark parking (turn right at first roundabout after exiting the tunnel leading to Atlantis, The Palm). </p>
            </div>
        </div>
    </section>
    ...
    <section class="review">
        ...
        <form method="post" action="./php/water3.php">
            <div class="em">
