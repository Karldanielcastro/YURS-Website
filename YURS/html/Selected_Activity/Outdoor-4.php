...
@media screen and (min-width: 0px) and (max-width: 1000px) {
  ...
  .menu > li {
    ...
    .img-1{
        background-image: url(image/out4-show1.jpg);
    }
    .img-2{
        background-image: url(image/out4-show2.jpg);
    }
    .img-3{
        background-image: url(image/out4-show3.jpg);
    }
...
<body>
  ...
  <section class="top-nav">
    ...
    <div class="box">
        <h1 id="letter">Jais Sky Maze</h1>
    </div>

    <section class="location">
    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d14350.832686644144!2d56.136981281057786!3d25.94480528686182!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3ef6635c1b8a1a81%3A0x213fc44eeec53359!2zSmFpcyBTa3kgTWF6ZSDZhdiq2KfZh9ipINis2YrYsyDYp9mE2YXYudmE2YLYqQ!5e0!3m2!1sen!2sae!4v1654123336771!5m2!1sen!2sae" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
        <img id = "state"src="image/ras.png">
    </section>
    ...
    <section class="about">
        ...
        <div class="about-pages">
            <div>
                <img class ="image-parallax" src="image/out4-des1.jpg">
                <p>Get your adrenaline rushing at a new obstacle maze on the UAE’s highest mountain! Find your sense of adventure 10 meters above the ground as you navigate through several obstacles including rope swings, wobbly bridges, swinging loops and so much more! With two levels of endless fun, the Jais Sky</p>
            </div>
            <div>
                <img class ="image-parallax" src="image/out4-des2.jpg">
                <p>The dramatic Jebel Jais mountainscapes are home to life-changing, adrenaline-pumping, awe-inspiring and cloud-piercing adventures and experiences. Are you brave enough?</p>
            </div>
            <div>
                <img class ="image-parallax" src="image/out4-des3.jpg">
                <p>The Jais Adventure Peak captures Ras Al Khaimah’s adventurous spirit through a series of adrenaline-pumping experiences that will leave a lasting impression on our guests and unforgettable memories.</p>
            </div>
        </div>
    </section>
    ...
    <section class="review">
        ...
        <form method="post" action="./php/out4.php">
            <div class="em">
