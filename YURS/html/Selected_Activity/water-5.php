...
@media screen and (min-width: 0px) and (max-width: 1000px) {
  ...
  .menu > li {
    ...
    .img-1{
        background-image: url(image/water5-show1.jpg);
    }
    .img-2{
        background-image: url(image/water5-show2.jpg);
    }
    .img-3{
        background-image: url(image/water5-show3.jpg);
    }
...
<body>
  ...
  <section class="top-nav">
    ...
    <div class="box">
        <h1 id="letter">Splash'n' Party Kids Waterpark</h1>
    </div>

    <section class="location">
    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3611.2889047202643!2d55.22131831500874!3d25.15972098391357!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3e5f6981982dceab%3A0x668749a5165c5b11!2sSplash%20&#39;n&#39;%20Party%20Kids%20Waterpark!5e0!3m2!1sen!2sae!4v1654126624600!5m2!1sen!2sae" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
    ...
    <section class="about">
        ...
        <div class="about-pages">
            <div>
                <img class ="image-parallax" src="image/water5-des1.jpg">
                <p>Get wet and splash around as you ride the aquatic waterslides and swim in the pools - or even fly down the thrilling zip line. This intimate, gated compound has something for everyone with splash pads for the little ones and a restaurant and juice bar for you.</p>
            </div>
            <div>
                <img class ="image-parallax" src="image/water5-des2.jpg">
                <p>Splash ’n’ Party is Dubai’s newest, coolest and most exciting water park at Kite Beach for kids. The park is designed to cater to the entire family – Whilst the little ones have a blast on our splash pads and water slides, the parents can kick back and relax .</p>
            </div>
            <div>
                <img class ="image-parallax" src="image/water5-des3.jpg">
                <p>Splash ’n’ Party caters to the most unforgettable birthday parties and other special events at our venue. With our extensive range of entertainment catered for the whole family, the only struggle you’ll have is getting your children to leave!!! Open from Sunday to Thursday: 3PM - 10PM and Friday and Saturday: 10AM - 10PM</p>
            </div>
        </div>
    </section>
    ...
    <section class="review">
        ...
        <form method="post" action="./php/water5.php">
            <div class="em">
