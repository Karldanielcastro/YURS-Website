...
@media screen and (min-width: 0px) and (max-width: 1000px) {
  ...
  .menu > li {
    ...
    .img-1{
        background-image: url(image/out6-show1.jpg);
    }
    .img-2{
        background-image: url(image/out6-show2.jpg);
    }
    .img-3{
        background-image: url(image/out6-show3.jpg);
    }
...
<body>
  ...
  <section class="top-nav">
    ...
    <div class="box">
        <h1 id="letter">Hike Jebel Hafeet</h1>
    </div>

    <section class="location">
    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3643.273250512565!2d55.775978614987174!3d24.056680184439244!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3e8abe9455d24f6f%3A0x6b19b6004a074ea4!2sJebel%20Hafeet!5e0!3m2!1sen!2sae!4v1654124264919!5m2!1sen!2sae" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
    ...
    <section class="about">
        ...
        <div class="about-pages">
            <div>
                <img class ="image-parallax" src="image/out6-des1.jpg">
                <p>Jebel Hafeet is the third highest peak in Abu Dhabi and the third highest in the UAE. It is also home to some of the most beautiful roads in the country. The summit of this mountain is 1200 meters (4000 feet) above sea level.</p>
            </div>
            <div>
                <img class ="image-parallax" src="image/out6-des2.jpg">
                <p>The Jebel Hafeet forms a part of the Hajar mountains. The major portion of the Hajar mountain region lies in Oman. This mountain range is the reason for the vastly different climate in Oman from that of the UAE.</p>
            </div>
            <div>
                <img class ="image-parallax" src="image/out6-des3.jpg">
                <p>The Jebel Hafeet region is cut in half between Oman and UAE. But the highest portion of the mountain is in Abu Dhabi.</p>
            </div>
        </div>
    </section>
    ...
    <section class="review">
        ...
        <form method="post" action="./php/out6.php">
            <div class="em">
